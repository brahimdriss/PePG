...
def plot_with_confidence_interval(
    ...
    if semilogy:
        ax.semilogy(iterations, mean_vals, color=color, linewidth=linewidth,
                   label=label, linestyle=linestyle, marker=marker, markersize=markersize,
                   markevery=markevery)
        ...
        ax.plot(iterations, mean_vals, color=color, linewidth=linewidth,
               label=label, linestyle=linestyle, marker=marker, markersize=markersize,
               markevery=markevery)
...
def style_axes(ax, xlabel: str, ylabel: str, title: str, fontsize: int = 20,
              title_fontsize: int = 22, tick_fontsize: int = 16,
              legend_fontsize: int = 14, legend_loc: str = 'lower right'):
    ax.set_xlabel(xlabel, fontsize=fontsize)
    ax.set_ylabel(ylabel, fontsize=fontsize)
    ax.set_title(title, fontsize=title_fontsize)
    ax.tick_params(labelsize=tick_fontsize)
    ax.legend(fontsize=legend_fontsize, loc=legend_loc, frameon=True,
